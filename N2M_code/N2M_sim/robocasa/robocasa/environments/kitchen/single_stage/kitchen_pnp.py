...
class PnPCounterToCab(PnP):
    ...
    # BUG [initialization] Shouldn't use this kind of generalization ...., move these settings into yaml or json file.
    def __init__(
        # self, cab_id=FixtureType.CABINET_TOP, obj_groups="all", *args, **kwargs
        # self, cab_id=FixtureType.CABINET_TOP, obj_groups=['apple'], *args, **kwargs
        self, cab_id="cab_main_main_group", obj_groups=['apple'], *args, **kwargs
    ):
    ...
    def _get_obj_cfgs(self):
        ...
        # distractors
        # VITAL [distractor] Remove the distractor for now. 
