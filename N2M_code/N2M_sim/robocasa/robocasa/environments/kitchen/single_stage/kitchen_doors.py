...
class OpenSingleDoor(OpenDoor):
    def __init__(
        # self, door_id="cab_main_main_group", *args, **kwargs
        self, door_id="microwave", *args, **kwargs
        # self, door_id="microwave_left_group", *args, **kwargs
        # self, door_id=FixtureType.DOOR_TOP_HINGE_SINGLE, *args, **kwargs
    ):
