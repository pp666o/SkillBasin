...
int main(int argc, char** argv) {
    ...
    std::string output_pcl_dir = dataset_path + "/rollout/pcl_robot_centric";
    std::string output_meta_path = dataset_path + "/rollout/meta_robot_centric.json";
    std::string camera_poses_path = dataset_path + "/rollout/camera_poses/robot_centric_camera_extrinsics.json";
    ...
    for (const auto& episode : meta["episodes"]) {
        ...
        for (int i = 0; i < camera_poses[episode_id].size(); i++) {
            ...
            std::string file_name = std::to_string(episode_id) + ".pcd";
            ...
            episode_aug["file_path"] = "pcl_robot_centric/" + file_name;
